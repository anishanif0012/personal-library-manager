...
def get_library_stats():
    ...
    for book in st.session_state.libraray:
    ...
    def create_visualization(stats):
        ...
        if stats['decades']:
            ...
            with st.form(key='add book_form'):
            ...
            if st.session_state.book_added:
                ...
                st.balloons()
                st.session_state.book_added = False
            elif st.session-state.current_view == "library":
                st.markdown("<h2 class= 'sub-header'> Your Library </h2>", unsafe_allow_html=True)

                if st.session_state.library:
                    st.markdown("<div class= 'warning-message'> Your libraray is empty. Add some books to get startes! </div>", unsafe_allow_html=True)
                else:
                    cols = st.columns(2)
            ...
            search_term = st.text_input("Enter search item:")
            ...
            """, unsafe_allow_html=True)
                ...
                if st.session_state.library:
                    st.markdown("<div class= 'warning-massage'. Your library is empty. Add some books to see statistics! </div>", unsafe_allow_html=True)
                else:
                    ...
                    with col2:
                        st.metric("Book Read", stats['book_read'])
                    with col3:
                        st.metric("Percentage Read", f"{stats['percentage_read'] :.if}%")
            ...
            st.markdown("---")
            st.markdown("Copyright @ 2025 Anis Hanif Personal Library Manager", unsafe_allow_html=True)
